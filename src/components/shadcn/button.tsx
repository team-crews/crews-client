...
const buttonVariants = cva(
  'font-pretendard inline-flex items-center justify-center whitespace-nowrap rounded text-sm font-bold tracking-widest',
  {
    variants: {
      variant: {
        default:
        ...
        black: 'bg-[#303030] text-crews-w01 hover:bg-[#000]',
